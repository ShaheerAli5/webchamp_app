...
class TemplateBotReplyScreen extends StatefulWidget {
  final Map<String, dynamic>? botData;
  const TemplateBotReplyScreen({super.key, this.botData});

  @override
  State<TemplateBotReplyScreen> createState() => _TemplateBotReplyScreenState();
}

class _TemplateBotReplyScreenState extends State<TemplateBotReplyScreen> {
          ...
          child: AppBar(
            ...
            title: Row(
              children: [
                ...
                SizedBox(width: 16.w),
                Text(
                  isEditing ? 'Edit Template Bot' : 'Template Bot Reply',
                  style: TextStyle(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildInputGroup('SELECT TEMPLATE', 'Select template', isDropdown: true),
